...
type Config struct {
	...
	BackoffSchedule string `env:"BACKOFF_SCHEDULE" envDefault:"100,500,1000"`
...
func NewConfig() (*Config, error) {
	...
	flag.StringVar(&cfg.BackoffSchedule, "b", cfg.BackoffSchedule, "Backoff schedule in milliseconds separated by commas")
